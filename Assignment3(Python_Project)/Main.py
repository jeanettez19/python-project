...
class MainWindow(Tk):
    def __init__(self):
        ...
        self.button3 = Button(frame, text="Set Budget", command=lambda:Budgets.open_BSwindow(self), font=("Arial", 12), fg="black")
        self.button3.pack(pady=10)  
                
        self.button4 = Button(frame, text="My Finances", command=lambda:MyFinances.open_MFwindow(self), font=("Arial", 12), fg="black")
