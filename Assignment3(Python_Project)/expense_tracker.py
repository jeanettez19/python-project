...
# Creating a class for our Expense Tracker Window
class ExpenseTracker:
    ...
    # Function to Open Expense Tracker Window
    def open_window(self):
        ...
        back_button = Button(
            top_f, text="Return to Main Window", command=window.destroy, bg="Firebrick", fg="White"
        )
        back_button.pack(side=LEFT)

        # Sample data for table display purposes
        expenses_data = Expenses.initialize_id_counter(
            current_directory + "/data/expense.xlsx", "expenses_id"
        )
